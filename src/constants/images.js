...
import subscribe_background from "../assets/images/subscribe_background.jpg";

const images = {
    header_background, pattern_00, pattern_1, 
     stat_img_1, stat_img_2, stat_img_3, stat_img_4, logo_img_1,
      logo_img_2, logo_img_3, logo_img_4, logo_img_5, logo_img_6, work_img_1, work_img_2, work_img_3, work_img_4, work_img_5, work_img_6, About_Alex, subscribe_background
}
